...
// WithSystem adds the system to the list datasources params
func (o *ListDatasourcesParams) WithSystem(system *string) *ListDatasourcesParams {
	o.SetSystem(system)
	return o
}

// SetSystem adds the system to the list datasources params
func (o *ListDatasourcesParams) SetSystem(system *string) {
	o.System = system
}

...
type ClientService interface {
	GetDecision(params *GetDecisionParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetDecisionOK, error)

	SearchDecisionLogsGet(params *SearchDecisionLogsGetParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*SearchDecisionLogsGetOK, error)

	SearchDecisionLogsPost(params *SearchDecisionLogsPostParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*SearchDecisionLogsPostOK, error)
...
*/
func (a *Client) GetDecision(params *GetDecisionParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetDecisionOK, error) {
...
*/
func (a *Client) SearchDecisionLogsGet(params *SearchDecisionLogsGetParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*SearchDecisionLogsGetOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) SearchDecisionLogsPost(params *SearchDecisionLogsPostParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*SearchDecisionLogsPostOK, error) {
	// TODO: Validate the params before sending
	if params == nil {

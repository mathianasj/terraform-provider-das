...
type ClientService interface {
	RunLogReplay(params *RunLogReplayParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*RunLogReplayOK, error)
...
*/
func (a *Client) RunLogReplay(params *RunLogReplayParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*RunLogReplayOK, error) {

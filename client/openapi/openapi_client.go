...
type ClientService interface {
	OpenAPIDeprecated(params *OpenAPIDeprecatedParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*OpenAPIDeprecatedOK, error)

	OpenAPIv2(params *OpenAPIv2Params, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*OpenAPIv2OK, error)

	OpenAPIv3(params *OpenAPIv3Params, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*OpenAPIv3OK, error)
...
*/
func (a *Client) OpenAPIDeprecated(params *OpenAPIDeprecatedParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*OpenAPIDeprecatedOK, error) {
...
*/
func (a *Client) OpenAPIv2(params *OpenAPIv2Params, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*OpenAPIv2OK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) OpenAPIv3(params *OpenAPIv3Params, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*OpenAPIv3OK, error) {
	// TODO: Validate the params before sending
	if params == nil {

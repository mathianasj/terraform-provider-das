...
func (o *CreatePoliciesParams) WithBody(body *models.PoliciesV2PoliciesPostRequest) *CreatePoliciesParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create policies params
func (o *CreatePoliciesParams) SetBody(body *models.PoliciesV2PoliciesPostRequest) {
	o.Body = body
}

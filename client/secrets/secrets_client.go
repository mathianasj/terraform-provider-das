...
type ClientService interface {
	CreateUpdateSecret(params *CreateUpdateSecretParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*CreateUpdateSecretOK, error)
...
*/
func (a *Client) CreateUpdateSecret(params *CreateUpdateSecretParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*CreateUpdateSecretOK, error) {

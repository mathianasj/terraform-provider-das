...
type ClientService interface {
	CommitFilesToSourceControlStack(params *CommitFilesToSourceControlStackParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*CommitFilesToSourceControlStackOK, error)
	...
	DeleteUserBranchStack(params *DeleteUserBranchStackParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DeleteUserBranchStackOK, error)

	GetSourceControlFilesBranchStack(params *GetSourceControlFilesBranchStackParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetSourceControlFilesBranchStackOK, error)

	GetSourceControlFilesMasterStack(params *GetSourceControlFilesMasterStackParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetSourceControlFilesMasterStackOK, error)

	GetStack(params *GetStackParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetStackOK, error)

	ListStacks(params *ListStacksParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ListStacksOK, error)

	SourceControlVerifyConfigStack(params *SourceControlVerifyConfigStackParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*SourceControlVerifyConfigStackOK, error)

	UpdateStack(params *UpdateStackParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateStackOK, error)

	ValidateStackCompliance(params *ValidateStackComplianceParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ValidateStackComplianceOK, *ValidateStackComplianceAccepted, error)

	ValidateStackTests(params *ValidateStackTestsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ValidateStackTestsOK, error)
...
*/
func (a *Client) CommitFilesToSourceControlStack(params *CommitFilesToSourceControlStackParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*CommitFilesToSourceControlStackOK, error) {
...
*/
func (a *Client) DeleteUserBranchStack(params *DeleteUserBranchStackParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DeleteUserBranchStackOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetSourceControlFilesBranchStack(params *GetSourceControlFilesBranchStackParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetSourceControlFilesBranchStackOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetSourceControlFilesMasterStack(params *GetSourceControlFilesMasterStackParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetSourceControlFilesMasterStackOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) ListStacks(params *ListStacksParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ListStacksOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) SourceControlVerifyConfigStack(params *SourceControlVerifyConfigStackParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*SourceControlVerifyConfigStackOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) ValidateStackCompliance(params *ValidateStackComplianceParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ValidateStackComplianceOK, *ValidateStackComplianceAccepted, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) ValidateStackTests(params *ValidateStackTestsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ValidateStackTestsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {

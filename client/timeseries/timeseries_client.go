...
type ClientService interface {
	HandleAdvice(params *HandleAdviceParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HandleAdviceOK, error)

	HandleDecision(params *HandleDecisionParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HandleDecisionOK, error)

	HandleDeny(params *HandleDenyParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HandleDenyOK, error)

	HandleError(params *HandleErrorParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HandleErrorOK, error)

	HandleLatency(params *HandleLatencyParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HandleLatencyOK, error)

	HandleTimeseriesMetrics(params *HandleTimeseriesMetricsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HandleTimeseriesMetricsOK, error)

	HandleUnknown(params *HandleUnknownParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HandleUnknownOK, error)

	HandleUsage(params *HandleUsageParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HandleUsageOK, error)

	HandleViolation(params *HandleViolationParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HandleViolationOK, error)
...
*/
func (a *Client) HandleAdvice(params *HandleAdviceParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HandleAdviceOK, error) {
...
*/
func (a *Client) HandleDecision(params *HandleDecisionParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HandleDecisionOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) HandleDeny(params *HandleDenyParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HandleDenyOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) HandleError(params *HandleErrorParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HandleErrorOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) HandleLatency(params *HandleLatencyParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HandleLatencyOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) HandleTimeseriesMetrics(params *HandleTimeseriesMetricsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HandleTimeseriesMetricsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) HandleUnknown(params *HandleUnknownParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HandleUnknownOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) HandleUsage(params *HandleUsageParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HandleUsageOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) HandleViolation(params *HandleViolationParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HandleViolationOK, error) {
	// TODO: Validate the params before sending
	if params == nil {

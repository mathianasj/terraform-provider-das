...
type ClientService interface {
	CreateUpdateUser(params *CreateUpdateUserParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*CreateUpdateUserOK, error)
...
*/
func (a *Client) CreateUpdateUser(params *CreateUpdateUserParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*CreateUpdateUserOK, error) {

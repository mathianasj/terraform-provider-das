...
func (m *WorkspaceV1S3ConfigPutRequest) validateKafka(formats strfmt.Registry) error {
...
func (m *WorkspaceV1S3ConfigPutRequest) contextValidateKafka(ctx context.Context, formats strfmt.Registry) error {
